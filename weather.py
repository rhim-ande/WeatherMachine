...
option_input = input("Enter one weather option: Forecast, Realtime Weather, History: ")


if option_input == "Forecast":
...
if option_input == "Realtime Weather":
    city_input = input("Enter your city name: ")
